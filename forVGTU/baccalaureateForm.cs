...
namespace forVGTU
{
    public partial class baccalaureateForm : Form
    {
        Database database = new Database();
        public baccalaureateForm()
        {
            InitializeComponent();
        }
        ...
        private void RefreshDataGrid(DataGridView dgw)
        {
            ...
            string query = $"select * from baccalaureate";
        ...
        private void Update()
        {
            ...
            for (int index = 0; index < dataGridView1.Rows.Count; index++)
            {
                ...
                if (rowState == RowState.Deleted)
                {
                    ...
                    var deleteQuery = $"delete from baccalaureate where id = {id}";
                ...
                if (rowState == RowState.Modified)
                {
                    ...
                    var changeQuery = $"update baccalaureate set direction_name = '{direction_name}' where id = '{id}'";
        ...
        {
            addBaccalaureate addSpo = new addBaccalaureate();
            addSpo.Show();
            this.Close();
        }
        ...
        private void baccalaureateForm_Load(object sender, EventArgs e)
        {
            CreateColumns();
