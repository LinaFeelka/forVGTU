...
namespace forVGTU
{
    public partial class magistracyForm : Form
    {
        Database database = new Database();

        public magistracyForm()
        {
            InitializeComponent();
        }
        ...
        private void RefreshDataGrid(DataGridView dgw)
        {
            ...
            string query = $"select * from magistracy";
        ...
        private void Update()
        {
            ...
            for (int index = 0; index < dataGridView1.Rows.Count; index++)
            {
                ...
                if (rowState == RowState.Deleted)
                {
                    ...
                    var deleteQuery = $"delete from magistracy where id = {id}";
                ...
                if (rowState == RowState.Modified)
                {
                    ...
                    var changeQuery = $"update magistracy set direction_name = '{direction_name}' where id = '{id}'";
        ...
        {
            addMagistracy addSpo = new addMagistracy();
            addSpo.Show();
            this.Close();
        }
